...
def download(url, file_dir):
    ...
    storage_url,storage_size = config["storage"]["url"], config["storage"]["size"]
...
if __name__ == '__main__':
    ...
    url = 'https://www.toutiao.com/article/7441617857798079030/?log_from=e065edf979d43_1732636772694'
